...
p. Following languages are  available: German, English, Russian (partially), Portuguese (partially), French (partially), Polish (by Alex Setlak - http://alek.magazynek.org/)
...
p. Upload this folder to your Dokuwiki plugin folder.

p. In Admin -> Configuration settings you have to set up a valid email address and (if you want) your reCaptcha keys. You can modify and redistribute it under the terms of the GPL Version 3.
...
| subj | When the subject is specified in the parameters, it is not a field on the contact form. |
