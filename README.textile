...
p. Following languages are  available: German, English, Russian (partially), Portuguese (partially), French (partially), Polish (by Alex Setlak), Spanish (by Cristian Wente)
